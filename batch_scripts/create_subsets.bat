...
REM Path to your main entrypoint and venv
...
FOR /L %%I IN (1,1,%N_THREADS%) DO (
    ...
    START "!INSTANCE_ID! Process" /B "%PYTHON_EXEC%" "%MAIN_PY%" %MODULE% %MODE% "!JOB_FILE!" %INPUT_DIR% %OUTPUT_DIR% %MIN_FILES%
    ENDLOCAL
)
