from dl_torch.models.UNet3D_Segmentation import UNet_Hilbig, UNet3D_16EL, UNet3D_16ELGN, UNet_HilbigGN
...
def get_model_by_name(model_name: str, n_classes):
    ...
    match code:
        ...
        case 2: return UNet3D_16ELGN(in_channels=1, out_channels=n_classes)
        case 3: return UNet_HilbigGN(in_channels=1, out_channels=n_classes)
