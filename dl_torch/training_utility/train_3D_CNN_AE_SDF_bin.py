...
def job_1():
    # Model Setup
    model_constructor = partial(Autoencoder_binary) # pass handle for constructor
    model_name = "Autoencoder_sdf2bin_rot"
    dataset_loc = r"../../data/datasets/ModelNet10/ModelNet10_AE_32_sdf2bin_train.torch"
...
def job_2():
    # Model Setup
    model_constructor = partial(Autoencoder_binary)  # pass handle for constructor
    model_name = "Autoencoder_bin2bin_decay0"
    dataset_loc = r"../../data/datasets/ModelNet10/ModelNet10_AE_SDF_32_bin_train.torch"
    model_weights_loc = "../../data/model_weights/{model_name}/{run_name}_save_{epoch}.pth"
